...
protected:
    ...
    int getHeight(Node<Key, Value>* root, bool& balanced) const;
...
void BinarySearchTree<Key, Value>::insert(const std::pair<const Key, Value> &keyValuePair)
{
    ...
    else
    {
        ...
        while(curr != NULL)
        {
            if(keyValuePair.first > curr->getKey()) //if greater than curr's key
            {
            ...
            else if(keyValuePair.first < curr->getKey()) //if less than curr's key
            {
...
void BinarySearchTree<Key, Value>::remove(const Key& key)
{
    ...
    while(curr != NULL)
    {
        ...
        else //if keys are equal, we have found it and now remove
        {
            //if it is a leaf (0 children)
            if(curr->getLeft() == NULL && curr->getRight() == NULL)
            {
                if(curr == root_) //if it is the root
                {
                    delete curr;
                    root_ = NULL;
                    return;
                }
                if(curr->getParent()->getLeft() == curr) //if it was a left child
                {
            ...
            else if(curr->getLeft() != NULL && curr->getRight() != NULL)
            {
                ...
                if(curr->getParent()->getLeft() == curr) //if it is now a left child
                {
            ...
            {
                if(curr == root_) //if node was the root
                {
                ...
                if(curr->getParent()->getLeft() == curr) //if node was a left child
                {
                    if(curr->getLeft() != NULL) //if the child is a left child
                    {
                        curr->getLeft()->setParent(curr->getParent());
...
BinarySearchTree<Key, Value>::predecessor(Node<Key, Value>* current)
{
    ...
    else //if no left child
    {
        ...
        {
            if(temp->getParent()->getRight() == temp) //if we find a right child
            {
        ...
        //if we get here, then we did not find a right child
        //this means current is already the smallest
        temp = NULL;
    }
    return temp;
}
...
BinarySearchTree<Key, Value>::successor(Node<Key, Value>* current)
{
    ...
    else //if no right child
    {
        ...
        while(temp->getParent() != NULL)
        {
            if(temp->getParent()->getLeft() == temp) //if we find a left child
            {
                return temp->getParent();
            }
            else
        ...
        //if we get here, then we did not find a left child
        //this means current is already the largest
        temp = NULL;
    }
    return temp;
}
...
//recursive helper function to clear a tree with post-order recursion
template<typename Key, typename Value>
...
{
    bool balanced = true;
    int height = getHeight(root_, balanced);
    if(height == 0)
    {
        return true;
    }
...
//helper function to get height of tree and changes bool to false if unbalanced
template<typename Key, typename Value>
int BinarySearchTree<Key, Value>::getHeight(Node<Key, Value>* root, bool& balanced) const
{  
    if(root == NULL)
    {
        return 0;
    ...
    {
        int left = getHeight(root->getLeft(), balanced);
        int right = getHeight(root->getRight(), balanced);
